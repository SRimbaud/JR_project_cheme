...
\hypertarget{read_8c_a5f436bcd6cba7ebae92b4278d43cf7d9}{}\label{read_8c_a5f436bcd6cba7ebae92b4278d43cf7d9} 
char $\ast$ \hyperlink{read_8c_a5f436bcd6cba7ebae92b4278d43cf7d9}{first\+\_\+usefull\+\_\+char} (char $\ast$line)
...
int \hyperlink{read_8c_abbe5cdc861f097aa41cb4e8ad88d53a8}{O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update} (\hyperlink{structobject__t}{object} o, char $\ast$input, uint $\ast$here)
\begin{DoxyCompactList}\small\item\em Lit un réel sur une entrée utilisateur. \end{DoxyCompactList}\item 
...
int \hyperlink{read_8c_aaa7a3fe5326b17d2e2858848680c1b44}{O\+B\+J\+E\+C\+T\+\_\+boolean\+\_\+update} (\hyperlink{structobject__t}{object} $\ast$o, char $\ast$input, uint $\ast$here)
...
\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336}{}\label{read_8c_a794da11e5e95baea1892357a25b44336} 
...
\subsubsection{\texorpdfstring{E\+X\+P\+R\+E\+S\+S\+I\+O\+N\+\_\+\+T\+Y\+P\+E\+\_\+T}{EXPRESSION\_TYPE\_T}}
{\footnotesize\ttfamily enum \hyperlink{read_8c_a794da11e5e95baea1892357a25b44336}{E\+X\+P\+R\+E\+S\+S\+I\+O\+N\+\_\+\+T\+Y\+P\+E\+\_\+T}}

\begin{DoxyEnumFields}{Valeurs énumérées}
\raisebox{\heightof{T}}[0pt][0pt]{\index{N\+O\+T\+H\+I\+NG@{N\+O\+T\+H\+I\+NG}!read.\+c@{read.\+c}}\index{read.\+c@{read.\+c}!N\+O\+T\+H\+I\+NG@{N\+O\+T\+H\+I\+NG}}}\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336acfe24a7b308a82835c8a9a9a89bc4ca2}{}\label{read_8c_a794da11e5e95baea1892357a25b44336acfe24a7b308a82835c8a9a9a89bc4ca2} 
N\+O\+T\+H\+I\+NG&rien n\textquotesingle{}a ete trouve encore.. \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{S\+T\+R\+I\+N\+G\+\_\+\+A\+T\+O\+ME@{S\+T\+R\+I\+N\+G\+\_\+\+A\+T\+O\+ME}!read.\+c@{read.\+c}}\index{read.\+c@{read.\+c}!S\+T\+R\+I\+N\+G\+\_\+\+A\+T\+O\+ME@{S\+T\+R\+I\+N\+G\+\_\+\+A\+T\+O\+ME}}}\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336a3789e89d60fe0d18548ebc6d3080e20f}{}\label{read_8c_a794da11e5e95baea1892357a25b44336a3789e89d60fe0d18548ebc6d3080e20f} 
S\+T\+R\+I\+N\+G\+\_\+\+A\+T\+O\+ME&la premiere trouvee dans la ligne semble etre un atome \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{B\+A\+S\+I\+C\+\_\+\+A\+T\+O\+ME@{B\+A\+S\+I\+C\+\_\+\+A\+T\+O\+ME}!read.\+c@{read.\+c}}\index{read.\+c@{read.\+c}!B\+A\+S\+I\+C\+\_\+\+A\+T\+O\+ME@{B\+A\+S\+I\+C\+\_\+\+A\+T\+O\+ME}}}\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336a26a9892b61e0aa5a24c1c1c7d57ebaab}{}\label{read_8c_a794da11e5e95baea1892357a25b44336a26a9892b61e0aa5a24c1c1c7d57ebaab} 
B\+A\+S\+I\+C\+\_\+\+A\+T\+O\+ME&la premiere trouvee dans la ligne semble etre d\textquotesingle{}une chaine \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{S\+\_\+\+E\+X\+P\+R\+\_\+\+P\+A\+R\+E\+N\+T\+H\+E\+S\+IS@{S\+\_\+\+E\+X\+P\+R\+\_\+\+P\+A\+R\+E\+N\+T\+H\+E\+S\+IS}!read.\+c@{read.\+c}}\index{read.\+c@{read.\+c}!S\+\_\+\+E\+X\+P\+R\+\_\+\+P\+A\+R\+E\+N\+T\+H\+E\+S\+IS@{S\+\_\+\+E\+X\+P\+R\+\_\+\+P\+A\+R\+E\+N\+T\+H\+E\+S\+IS}}}\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336a52eaf1b8684255efd41eadf2e613cf28}{}\label{read_8c_a794da11e5e95baea1892357a25b44336a52eaf1b8684255efd41eadf2e613cf28} 
S\+\_\+\+E\+X\+P\+R\+\_\+\+P\+A\+R\+E\+N\+T\+H\+E\+S\+IS&la premiere trouvee dans la ligne semble etre une expression parenthesee \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{F\+I\+N\+I\+S\+H\+ED@{F\+I\+N\+I\+S\+H\+ED}!read.\+c@{read.\+c}}\index{read.\+c@{read.\+c}!F\+I\+N\+I\+S\+H\+ED@{F\+I\+N\+I\+S\+H\+ED}}}\hypertarget{read_8c_a794da11e5e95baea1892357a25b44336adbd1812bee789fbf3548cf79d3f2b400}{}\label{read_8c_a794da11e5e95baea1892357a25b44336adbd1812bee789fbf3548cf79d3f2b400} 
F\+I\+N\+I\+S\+H\+ED&on a trouve une S-\/\+Expr bien formee \\
\hline
...
{\footnotesize\ttfamily void flip (\begin{DoxyParamCaption}\item[{uint $\ast$}]{i }\end{DoxyParamCaption})}
...
Retourne !i. 
\end{DoxyReturn}
\hypertarget{read_8c_aaa7a3fe5326b17d2e2858848680c1b44}{}\label{read_8c_aaa7a3fe5326b17d2e2858848680c1b44} 
...
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+boolean\+\_\+update()}{OBJECT\_boolean\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+boolean\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object} $\ast$}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+character\+\_\+update()}{OBJECT\_character\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+character\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object}}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+int\+\_\+update()}{OBJECT\_int\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+int\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object}}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
La fonction gère aussi l\textquotesingle{}overflow, si l\textquotesingle{}entier est trop grand (ou trop petit négatif) le type est mis à S\+F\+S\+\_\+\+N\+U\+M\+B\+ER et la valeur à + ou -\/inf.(voir N\+U\+M\+\_\+build ) Dans ce cas affiche un W\+A\+R\+N\+I\+NG et retourne 2.~\newline
...
\end{DoxyReturn}
\hypertarget{read_8c_abbe5cdc861f097aa41cb4e8ad88d53a8}{}\label{read_8c_abbe5cdc861f097aa41cb4e8ad88d53a8} 
\index{read.\+c@{read.\+c}!O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update@{O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update}}
\index{O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update@{O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update}!read.\+c@{read.\+c}}
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update()}{OBJECT\_real\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+real\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object}}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}



Lit un réel sur une entrée utilisateur. 

Lit un réel. La virgule doit être un point. Cette fonction est appelée par O\+B\+J\+E\+C\+T\+\_\+int\+\_\+update lorsque le caractère d\textquotesingle{}arrêt est un point son retour est utilisé par cette même fonction.

\begin{DoxySeeAlso}{Voir également}
strtold
\end{DoxySeeAlso}
\begin{DoxyReturn}{Renvoie}
Renvoie 2 si overflow, 1 si entrée mauvaise, 0 sinon. 
\end{DoxyReturn}
...
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+string\+\_\+update()}{OBJECT\_string\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+string\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object}}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{O\+B\+J\+E\+C\+T\+\_\+symbol\+\_\+update()}{OBJECT\_symbol\_update()}}
{\footnotesize\ttfamily int O\+B\+J\+E\+C\+T\+\_\+symbol\+\_\+update (\begin{DoxyParamCaption}\item[{\hyperlink{structobject__t}{object}}]{o,  }\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{sfs\+\_\+get\+\_\+sexpr()}{sfs\_get\_sexpr()}}
{\footnotesize\ttfamily uint sfs\+\_\+get\+\_\+sexpr (\begin{DoxyParamCaption}\item[{char $\ast$}]{input,  }\item[{F\+I\+LE $\ast$}]{fp }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{sfs\+\_\+read()}{sfs\_read()}}
{\footnotesize\ttfamily \hyperlink{structobject__t}{object} sfs\+\_\+read (\begin{DoxyParamCaption}\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{sfs\+\_\+read\+\_\+atom()}{sfs\_read\_atom()}}
{\footnotesize\ttfamily \hyperlink{structobject__t}{object} sfs\+\_\+read\+\_\+atom (\begin{DoxyParamCaption}\item[{char $\ast$}]{input,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
...
\item O\+B\+J\+E\+C\+T\+\_\+boolean\+\_\+update(object o, char$\ast$ input, uint$\ast$ here)
...
\subsubsection{\texorpdfstring{sfs\+\_\+read\+\_\+pair()}{sfs\_read\_pair()}}
{\footnotesize\ttfamily \hyperlink{structobject__t}{object} sfs\+\_\+read\+\_\+pair (\begin{DoxyParamCaption}\item[{char $\ast$}]{stream,  }\item[{uint $\ast$}]{i }\end{DoxyParamCaption})}
...
\subsubsection{\texorpdfstring{sfs\+\_\+type\+\_\+atom()}{sfs\_type\_atom()}}
{\footnotesize\ttfamily int sfs\+\_\+type\+\_\+atom (\begin{DoxyParamCaption}\item[{char $\ast$}]{chaine,  }\item[{uint $\ast$}]{here }\end{DoxyParamCaption})}
